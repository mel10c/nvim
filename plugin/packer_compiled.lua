...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'Comment.nvim', 'nvim-lspconfig', 'indent-blankline.nvim', 'which-key.nvim', 'nvim-web-devicons'}, { event = "BufEnter *" }, _G.packer_plugins)]]
