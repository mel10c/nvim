...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'ultisnips', 'bullets.vim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'ultisnips', 'bullets.vim', 'vim-table-mode'}, { ft = "pandoc" }, _G.packer_plugins)]]
