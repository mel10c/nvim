...
_G.packer_plugins = {
  ...
  ["cmp-buffer"] = {
    after = { "cmp-path", "cmp-look", "cmp-latex-symbols", "cmp-calc" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "nvim-autopairs", "cmp-nvim-lua", "vim-surround" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'noice.nvim', 'which-key.nvim', 'packer.nvim', 'onenord.nvim', 'vim-matchup'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-nvim-lsp', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'telescope-fzf-native.nvim', 'nvim-treesitter', 'nui.nvim', 'Comment.nvim', 'nvim-lspconfig', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
