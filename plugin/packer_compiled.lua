...
_G.packer_plugins = {
  ...
  ["cmp-buffer"] = {
    after = { "cmp-path", "cmp-markdown-link", "cmp-latex-symbols", "cmp-calc", "cmp-look" },
  ...
  ["cmp-markdown-link"] = {
    after_files = { "/Users/melaneyzhu/.local/share/nvim/site/pack/packer/opt/cmp-markdown-link/after/plugin/cmp-markdown-link.lua" },
    load_after = {
      ["cmp-buffer"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/melaneyzhu/.local/share/nvim/site/pack/packer/opt/cmp-markdown-link",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-buffer", "nvim-autopairs", "vim-surround" },
  ...
  ["telekasten.nvim"] = {
    ...
    url = "https://github.com/mel10c/telekasten.nvim"
  },
...
pcall(vim.api.nvim_create_user_command, 'SessionSave', function(cmdargs)
          require('packer.load')({'dashboard-nvim'}, { cmd = 'SessionSave', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'dashboard-nvim'}, {}, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'SessionLoad', function(cmdargs)
          require('packer.load')({'dashboard-nvim'}, { cmd = 'SessionLoad', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'dashboard-nvim'}, {}, _G.packer_plugins)
...
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'vim-table-mode', 'vim-pandoc-syntax'}, { ft = "pandoc" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-table-mode', 'vim-pandoc-syntax'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-matchup', 'noice.nvim', 'onenord.nvim', 'which-key.nvim', 'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'ultisnips', 'cmp-nvim-lsp', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nui.nvim', 'Comment.nvim', 'indent-blankline.nvim', 'nvim-lspconfig', 'telescope-fzf-native.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
