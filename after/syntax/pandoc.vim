...
" Statistical
syn match mdMathSymbol '\\hat{\s*\\sigma\s*}' contained conceal cchar=ȏ
syn match mdMathSymbol '\\hat{\s*p\s*}' contained conceal cchar=p̑
syn match mdMathSymbol '\\bar{\s*x\s*}' contained conceal cchar=x͡
syn match mdMathSymbol '\\bar{\s*X\s*}' contained conceal cchar=X͡
