...
syn match texMathSymbol '\\mathcal{\s*B\s*}' contained conceal cchar=ℬ
syn match texMathSymbol '\\mathcal{\s*E\s*}' contained conceal cchar=ℰ
syn match texMathSymbol '\\mathcal{\s*F\s*}' contained conceal cchar=ℱ
syn match texMathSymbol '\\mathcal{\s*J\s*}' contained conceal cchar=ℐ
syn match texMathSymbol '\\mathcal{\s*L\s*}' contained conceal cchar=ℒ
syn match texMathSymbol '\\mathcal{\s*Z\s*}' contained conceal cchar=𝖹
