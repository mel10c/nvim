...
syn match texMathSymbol '\\hat{\s*\\sigma\s*}' contained conceal cchar=ö
syn match texMathSymbol '\\hat{\s*p\s*}' contained conceal cchar=ṗ
syn match texMathSymbol '\\bar{\s*x\s*}' contained conceal cchar=ẍ
syn match texMathSymbol '\\bar{\s*X\s*}' contained conceal cchar=Ẍ
